...
class DimensionamientoRecord(Base):
    ...
    cliente_nombre_homologado = Column(String(255), nullable=True, index=True)
    cliente_nombre_original = Column(String(255), nullable=True)
    ...
    clasificacion_suizo = Column(String(255), nullable=True)
    descripcion_articulo = Column(Text, nullable=True)
    familia = Column(String(255), nullable=True, index=True)
    unidad_negocio = Column(String(255), nullable=True, index=True)
    subunidad_negocio = Column(String(255), nullable=True, index=True)
    ...
    producto_nombre_original = Column(String(255), nullable=True)
