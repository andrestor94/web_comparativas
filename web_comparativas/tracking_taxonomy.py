...
SECTIONS: List[dict] = [
    ...
    # Oportunidades de Venta del Mercado Privado: sección PROPIA, distinta de la de
    # Mercado Público ("mercado_publico_oportunidades") y de Dimensionamiento. Antes
    # caía mal en "dimensionamiento" porque no existía esta clave (ver DETECT_RULES).
    {"key": "mercado_privado_oportunidades", "label": "Oportunidades — Mercado Privado",
     "module": "mercado_privado", "room": ROOM_MERCADO_PRIVADO,
     "aliases": ["mercado_privado_oportunidades"]},
...
DETECT_RULES: List[tuple] = [
    ...
    ("contains", "mercado-privado/oportunidades", "mercado_privado_oportunidades"),
